...
int main(){
	...
	printf("\n l'operazione è finita, il file output contiene ora la frase cifrata mentre il file out_def contine una copia della frase inserita");
}
